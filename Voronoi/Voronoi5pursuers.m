...
Filename = sprintf('optimization_4pursuers_%s.csv', datestr(now,'mm-dd-yyyy HH-MM'));

fullFileName = fullfile(csvpath, Filename);
csvtitle = {'time', 'Evader_x', 'Evader_y', 'Pursuer1_x', 'Pursuer1_y', 'Pursuer2_x', 'Pursuer2_y', 'Puruser3_x', 'Pursuer3_y', 'Pursuer4_x', 'Pursuer4_y'};
...
x = [A(1) B1(1) B2(1) B3(1) B4(1) B5(1)];
y = [A(2) B1(2) B2(2) B3(2) B4(2) B5(2)];
 ...
 %   y(1) = a2(f);
  ...
  %% Plotting
   ...
   % plot(vx2,vy2)
    ...
    %% csv save
    data = [time,x(1),y(1),x(2),y(2),x(3),y(3),x(4),y(4),x(5),y(5)];
    dlmwrite(fullFileName,data,'-append');
    
end
legend('Evader', 'Pursuer1', 'Pursuer2', 'Pursuer3', 'Pursuer4', 'Pursuer5')

...
x = [A(1) B1(1) B2(1) B3(1) B4(1) B5(1) B6(1) B7(1) B8(1)];
y = [A(2) B1(2) B2(2) B3(2) B4(2) B5(2) B6(2) B7(2) B8(2)];
 ...
 %   y(1) = a2(f);
  ...
  %% Plotting
   ...
   % plot(vx2,vy2)
    ...
    %% csv save
    data = [time,x(1),y(1),x(2),y(2),x(3),y(3),x(4),y(4),x(5),y(5),x(6),y(6),x(7),y(7),x(8),y(8), x(9),y(9)];
    dlmwrite(fullFileName,data,'-append');
    
end
legend('Evader', 'Pursuer1', 'Pursuer2', 'Pursuer3', 'Pursuer4', 'Pursuer5','Pursuer6','Pursuer7', 'Pursuer8')

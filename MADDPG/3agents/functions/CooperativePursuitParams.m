...
% X Limit for Design Space
    ...
    observation1 = [Evader(1) Evader(2) Pursuer1(1) Pursuer1(2) Distance1 Distance2 Distance3 90];
    observation2 = [Evader(1) Evader(2) Pursuer2(1) Pursuer2(2) Distance1 Distance2 Distance3 90];
    observation3 = [Evader(1) Evader(2) Pursuer3(1) Pursuer3(2) Distance1 Distance2 Distance3 90];
